...
const Hero = React.forwardRef<HTMLElement, unknown>((_, ref) => {
  return (
    <main
      ref={ref}
      className="flex flex-col overflow-hidden pt-30 md:pt-48 bg-neutral-950 items-center text-neutral-50 min-h-screen mx-auto text-center"
    >
      <motion.p
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        performant, user-friendly, and scalable applications. Skilled in devleoping AI and ML models, analyzing complex datasets, and implementing neural language processing techniques.
      </motion.h4>
      ...
      >
        <motion.a
          ...
          whileHover="hover"
          href="https://www.linkedin.com/in/rudranarayan-sahu-b7b9a6244/" // Replace '#' with your LinkedIn profile URL
          target="_blank"
        ...
        <motion.a
          ...
          href="https://drive.google.com/file/d/1nKoPknPEWqZxoWRlfBJNRNzSTtm8fc5W/view?usp=sharing" // Replace '#' with the Google Drive link to your resume
          target="_blank"
          rel="noopener noreferrer"
